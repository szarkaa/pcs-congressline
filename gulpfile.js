...
gulp.task('copy:summernote-fonts', function () {
    gulp.src(config.bower + '/summernote/dist/font/**')
        .pipe(gulp.dest(config.dist + './content/css/font'));
});
...
gulp.task('assets:prod', ['images', 'styles', 'html', 'copy:swagger', 'copy:images', 'copy:summernote-fonts'], build);
