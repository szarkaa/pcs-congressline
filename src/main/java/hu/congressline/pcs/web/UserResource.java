...
public class UserResource {
    ...
    public ResponseEntity<?> createUser(@RequestBody ManagedUserVM managedUserVM, HttpServletRequest request) throws URISyntaxException {
        ...
        if (userRepository.findOneByLogin(managedUserVM.getLogin().toLowerCase()).isPresent()) {
            ...
            return ResponseEntity.badRequest()
                .headers(HeaderUtil.createFailureAlert("currency", "emailexists", "Email already in use"))
                .body(null);
        } else {
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable String login) {
        ...
        try {
            ...
            return ResponseEntity.badRequest().headers(HeaderUtil.createDeleteConstraintViolationAlert("userManagement", e)).body(null);
        }
