...
import static hu.congressline.pcs.config.Constants.SPRING_PROFILE_DEVELOPMENT;
import static hu.congressline.pcs.config.Constants.SPRING_PROFILE_NO_LIQUIBASE;
...
public class AsyncSpringLiquibase extends DataSourceClosingSpringLiquibase {
    ...
    private boolean isAsyncProfileActive() {
        return env.acceptsProfiles(Profiles.of(SPRING_PROFILE_DEVELOPMENT));
    }
