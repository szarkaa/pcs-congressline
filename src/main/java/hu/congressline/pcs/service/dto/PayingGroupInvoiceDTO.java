...
@Data
@NoArgsConstructor
public class PayingGroupInvoiceDTO implements Serializable {

    private Long invoicePayingGroupId;
    ...
    public PayingGroupInvoiceDTO(InvoicePayingGroup invoicePayingGroup) {
        this.invoicePayingGroupId = invoicePayingGroup.getId();
        var invoice = invoicePayingGroup.getInvoice();
        ...
        this.dateOfGroupPayment = invoicePayingGroup.getDateOfGroupPayment();
        this.payingGroupId = invoicePayingGroup.getPayingGroup().getId();
        this.payingGroupName = invoicePayingGroup.getPayingGroup().getName();
        this.congressId = invoicePayingGroup.getPayingGroup().getCongress().getId();
    }

    @Override
    public String toString() {
        return "PayingGroupInvoiceDTO{" + "invoicePayingGroupId=" + invoicePayingGroupId + "}";
    }
}
