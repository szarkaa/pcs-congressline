...
@NoArgsConstructor
@Data
public class RegistrationRegistrationTypeDTO {
    private Long id;
    ...
    public RegistrationRegistrationTypeDTO(RegistrationRegistrationType rrt) {
        this.id = rrt.getId();
    ...
    public boolean equals(Object o) {
        ...
        RegistrationRegistrationTypeDTO that = (RegistrationRegistrationTypeDTO) o;
